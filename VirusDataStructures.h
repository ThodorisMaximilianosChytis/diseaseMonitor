...
class LLNode{
	private:
		...
		LLNode* Next;
	public:
		LLNode(int,string,string,string,string,string,string);
		~LLNode(void);
		void Print(void);
		int getid();
...
class LList{
	...
	public:
		LList();
		~LList();
		void Insert(int,string,string,string,string,string,string);
		LLNode* Insert(int,string);
		LList* Remove();
		LLNode* Search(int);
		LLNode* getLLHead();
		void Print();
...
class Bucket{
	...
	public:
		...
		void PrintdiseaseFrequency(string *,string *, string*, string*);
